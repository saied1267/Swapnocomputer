      ...
      <div className="space-y-5 bg-slate-50/50 p-6 rounded-3xl border border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {displayPhotos.length > 0 ? (
            ...
            <div className="col-span-full py-20 bg-white border border-dashed border-slate-200 rounded-3xl text-center space-y-3">
              <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto text-slate-300">
                <ImageIcon className="w-8 h-8" />
              </div>
              <div className="space-y-1">
                <p className="text-slate-600 font-bold text-sm">গ্যালারিতে এখনো কোনো ছবি নেই</p>
                <p className="text-[10px] text-slate-400">অ্যাডমিন প্যানেল থেকে ল্যাব গ্যালারির ছবি আপলোড করুন।</p>
              </div>
            </div>
          )}
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 items-start text-xs text-slate-600">
                ...
                <div>
                  ...
                  <span className="font-mono block text-slate-500">০১৯৪১৬৫২০৯৭ (মোহাম্মদ সাঈদ স্যার)</span>
                </div>
              </div>
            ...
            <div className="h-64 bg-slate-50 border border-slate-100 rounded-xl relative overflow-hidden flex items-center justify-center">
              ...
              <div className="z-10 p-5 max-w-sm text-center space-y-4">
                ...
                <div className="text-[11px] text-slate-500 space-y-1 select-none font-medium">
                  ...
                  <p className="font-bold text-slate-800">📍 হাজি ইব্রাহিম মার্কেট ২য় তলা, কলেজ রোড</p>
                </div>
              </div>
            </div>
