      ...
      <header className="bg-white border-b border-slate-150 shadow-sm sticky top-0 z-40 no-print py-3 sm:py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4">
              ...
              >
                <div className="w-10 h-10 md:w-14 md:h-14 bg-gradient-to-tr from-indigo-700 via-indigo-650 to-violet-700 rounded-full flex items-center justify-center text-white shadow-lg shadow-indigo-150 group-hover:scale-105 group-hover:rotate-3 transition-all duration-500 shrink-0 border-2 border-white">
                  <School className="w-5 h-5 md:w-7 md:h-7 text-white" />
                </div>
                <div className="text-left leading-tight shrink-0">
                  <h1 className="text-xl md:text-3xl font-black text-slate-950 tracking-tight flex flex-col sm:flex-row items-center gap-2 font-sans relative group-hover:text-indigo-750 transition-colors">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-slate-950 via-indigo-900 to-slate-950">স্বপ্ন কারিগরি কম্পিউটার</span> 
                    <span className="text-white bg-indigo-600 border-2 border-white px-2.5 py-0.5 rounded-lg font-black text-xs md:text-lg shadow-md relative inline-block animate-[pulse_3s_infinite]">
                      প্রশিক্ষন কেন্দ্র
                    </span>
                  </h1>
                  <p className="text-[8px] md:text-[10px] text-slate-400 font-extrabold tracking-wider font-mono mt-1 flex items-center gap-1.5 opacity-90 uppercase">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 inline-block animate-pulse"></span>
                    SWAPNO TECHNICAL COMPUTER TRAINING CENTER • ESTD 2025
                  </p>
                </div>
              </div>
            </div>
