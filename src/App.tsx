              ...
              <div className="bg-white p-6 md:p-12 rounded-3xl border border-slate-100 py-10 relative overflow-hidden shadow-xs text-left">
                ...
                <div className="space-y-6 max-w-4xl z-10 relative">
                  ...
                  <p className="text-slate-650 text-sm md:text-base leading-relaxed max-w-3xl font-medium">
                    স্বপ্ন কারিগরি ও কম্পিউটার সেন্টারে সম্পূর্ণ কোলাহলমুক্ত নিরিবিলি পরিবেশে আপনি পাচ্ছেন প্রফেশনাল কোর্স সুবিধা। আমাদের ল্যাবে লার্জ মাল্টিমিডিয়া স্ক্রিন এবং ডেডিকেটেড হাই-কনফিগারেশন কম্পিউটার রয়েছে। সাঈদ স্যারের সরাসরি তত্ত্বাবধানে আপনি পাবেন প্র্যাক্টিক্যাল ক্যারিয়ার ।
                  </p>
